...
When I was learning C programming language then I have solved college assignments and various important problems from hackerrank, codechef, leetcode etc.
